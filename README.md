...
Для того щоб наш клієнт успішно доєднався до домену, вони мають бути в одній мережі і виступав в ролі днс для клієнта, тому наступним кроком ми конфігуруємо мережу на машині клієнта
